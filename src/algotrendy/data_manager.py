...
# Heavy libraries (pandas, numpy, yfinance, ta) are imported lazily inside
# the functions that need them to avoid import-time failures in lightweight
# test environments.
...
class DataManager:
    ...
    def _apply_chart_style(self, df, chart_style: str, interval: str):
        """
